            ...
            <div class="sidebar-nav slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    ...
                    <li> <a href="javascript:void(0)" class="waves-effect"></i><span class="hide-menu"> View <span class="fa arrow"></span> </span></a>
                     ...
                     <li> <a href="javascript:void(0)" class="waves-effect"><span class="hide-menu"> Manage <span class="fa arrow"></span> </span></a>
                        <ul class="nav nav-second-level">

                    <li><a href="{{ url('/lab') }}" class="waves-effect"><i class="icon-briefcase fa-fw"></i> <span class="hide-menu">Medical Labs<span class="fa arrow"></span><span class="label label-rouded label-warning pull-right"></span></span></a>
                    ...
                    <li class="devider"></li>
                    <li> <a href="javascript:void(0)" class="waves-effect"><span class="hide-menu">{{ Auth::user()->name }}</span> <span class="label label-rouded label-success">admin</span></a>
