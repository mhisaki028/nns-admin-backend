        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    ...
                    <li><a href="{{ url('/lclabhome') }}" class="waves-effect"> <span class="hide-menu"> Dashboard <span class="fa arrow"></span> <span class="label label-rouded label-inverse pull-right"></span></span></a>
                    </li>
                    ...
                    <li class="devider"></li>
                    <li> <a href="javascript:void(0)" class="waves-effect"><span class="hide-menu">{{ Auth::user()->name }}</span><span class="label label-rouded label-success">lab</span></a>
                    </li>
